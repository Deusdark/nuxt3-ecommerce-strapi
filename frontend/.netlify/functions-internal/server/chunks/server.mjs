...
const vueuseHead_69e5ca96 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_651e46ae = defineNuxtPlugin((nuxtApp) => {
...
const NuxtChild = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$9]]);
const layouts = {
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$8]]);
const routes = [
  {
    "name": "categories-id",
    "path": "/categories/:id",
    "file": "C:/Y/Training/nuxtjs3/nuxt3-ecommerce-strapi/frontend/pages/categories/[id].vue",
    "children": [],
  ...
  },
  {
    "name": "index",
    "path": "/",
    "file": "C:/Y/Training/nuxtjs3/nuxt3-ecommerce-strapi/frontend/pages/index.vue",
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return index;
    })
  },
  {
    "name": "products-id",
    "path": "/products/:id",
    "file": "C:/Y/Training/nuxtjs3/nuxt3-ecommerce-strapi/frontend/pages/products/[id].vue",
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return _id_;
    })
...
const router_7c149b96 = defineNuxtPlugin((nuxtApp) => {
...
const fetch$1 = getGlobal().fetch || (() => {
  return Promise.reject(new Error("[ohmyfetch] globalThis.fetch is not supported!"));
});
const $fetch = createFetch({ fetch: fetch$1 });
if (!globalThis.$fetch) {
  globalThis.$fetch = $fetch;
}
const nitroClient_8fe92496 = () => {
};
const components = {
  "Buttons": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return Buttons;
  }).then((c) => c.default || c)),
  ...
  "IconsCart": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return cart;
  }).then((c) => c.default || c)),
  "IconsFacebook": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return facebook;
  }).then((c) => c.default || c)),
  "IconsGithub": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return github;
  }).then((c) => c.default || c)),
  "IconsTwitter": vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
    return twitter;
  }).then((c) => c.default || c))
};
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$c = {
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext = {}) {
    ...
    vueApp.component("App", _sfc_main$c);
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><path d="M1.10512 0.368718C0.560256 0.368718 0.118164 0.812066 0.118164 1.35848C0.118164 1.9049 0.560256 2.34824 1.10512 2.34824H4.90887L8.30138 18.4009C8.43503 19.0053 8.83085 19.5079 9.32946 19.5041H25.7788C26.3005 19.5118 26.7799 19.0375 26.7799 18.5143C26.7799 17.9911 26.3006 17.5168 25.7788 17.5245H10.1315L9.71003 15.545H27.095C27.5371 15.5412 27.9547 15.2048 28.0511 14.7718L30.354 4.87412C30.4825 4.29933 29.9852 3.67172 29.3979 3.66786H7.21171L6.6771 1.15221C6.58329 0.71276 6.15921 0.368652 5.7107 0.368652L1.10512 0.368718ZM7.623 5.64746H12.7634L13.2569 8.61674H8.25005L7.623 5.64746ZM14.7785 5.64746H20.9881L20.4946 8.61674H15.2719L14.7785 5.64746ZM23.0031 5.64746H28.1537L27.4649 8.61674H22.5097L23.0031 5.64746ZM8.67181 10.5963H13.5862L14.0797 13.5656H9.29919L8.67181 10.5963ZM15.6009 10.5963H20.1656L19.6721 13.5656H16.0944L15.6009 10.5963ZM22.1807 10.5963H27.0023L26.3135 13.5656H21.6872L22.1807 10.5963ZM12.6197 20.164C10.8141 20.164 9.32979 21.6525 9.32979 23.4632C9.32979 25.2739 10.8141 26.7624 12.6197 26.7624C14.4252 26.7624 15.9095 25.2739 15.9095 23.4632C15.9095 21.6525 14.4252 20.164 12.6197 20.164ZM22.4892 20.164C20.6837 20.164 19.1994 21.6525 19.1994 23.4632C19.1994 25.2739 20.6837 26.7624 22.4892 26.7624C24.2948 26.7624 25.7791 25.2739 25.7791 23.4632C25.7791 21.6525 24.2948 20.164 22.4892 20.164ZM12.6197 22.1435C13.3586 22.1435 13.9356 22.7222 13.9356 23.4632C13.9356 24.2042 13.3586 24.7829 12.6197 24.7829C11.8807 24.7829 11.3037 24.2042 11.3037 23.4632C11.3037 22.7222 11.8807 22.1435 12.6197 22.1435ZM22.4892 22.1435C23.2282 22.1435 23.8052 22.7222 23.8052 23.4632C23.8052 24.2042 23.2282 24.7829 22.4892 24.7829C21.7503 24.7829 21.1733 24.2042 21.1733 23.4632C21.1733 22.7222 21.7503 22.1435 22.4892 22.1435Z" class="fill-current text-indigo-500"></path></svg>`);
}
const _sfc_setup$b = _sfc_main$b.setup;
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/icons/cart.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$6]]);
const cart = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": __nuxt_component_0$2
});
const _imports_0 = "/_nuxt/assets/strapi.59a661e6.png";
const _sfc_main$a = {};
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
  const _component_IconsCart = __nuxt_component_0$2;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex justify-between ml-6 mr-6 mt-4" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "/" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="emoji"${_scopeId}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} class="logo" height="150" width="150"${_scopeId}></span>`);
      } else {
        return [
          vue_cjs_prod.createVNode("span", { class: "emoji" }, [
  ...
  _push(`<button class="snipcart-checkout flex items-center">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_IconsCart, null, null, _parent));
  _push(`<span class="snipcart-total-price ml-3 font-semibold text-sm text-indigo-500"></span></button></div>`);
}
...
const _sfc_main$9 = {
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("categories", () => fetch(`${config.STORE_URL}/categories`).then((response) => response.json()))), __temp = await __temp, __restore(), __temp);
    const categories = data;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_nuxt_link = vue_cjs_prod.resolveComponent("nuxt-link");
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "" }, _attrs))}>`);
      if (vue_cjs_prod.unref(error)) {
        _push(`<div>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(error))}</div>`);
      } else {
        _push(`<div><div class="container flex flex-wrap mx-auto ml-4 mr-6 mt-8"><!--[-->`);
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/Buttons.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const Buttons = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _sfc_main$9
});
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<svg${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    ...
    class: "fill-current text-gray-600"
  }, _attrs))}><g><g><path d="M512,97.248c-19.04,8.352-39.328,13.888-60.48,16.576c21.76-12.992,38.368-33.408,46.176-58.016
			...
			C480.224,136.96,497.728,118.496,512,97.248z"></path></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>`);
}
const _sfc_setup$8 = _sfc_main$8.setup;
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/icons/twitter.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$4]]);
const twitter = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<svg${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    ...
    xmlns: "http://www.w3.org/2000/svg",
    class: "fill-current text-gray-600"
  }, _attrs))}><path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z"></path></svg>`);
}
const _sfc_setup$7 = _sfc_main$7.setup;
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/icons/facebook.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$3]]);
const facebook = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<svg${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    ...
    class: "fill-current text-gray-600",
    xmlns: "http://www.w3.org/2000/svg"
  }, _attrs))}><path d="m12 .5c-6.63 0-12 5.28-12 11.792 0 5.211 3.438 9.63 8.205 11.188.6.111.82-.254.82-.567 0-.28-.01-1.022-.015-2.005-3.338.711-4.042-1.582-4.042-1.582-.546-1.361-1.335-1.725-1.335-1.725-1.087-.731.084-.716.084-.716 1.205.082 1.838 1.215 1.838 1.215 1.07 1.803 2.809 1.282 3.495.981.108-.763.417-1.282.76-1.577-2.665-.295-5.466-1.309-5.466-5.827 0-1.287.465-2.339 1.235-3.164-.135-.298-.54-1.497.105-3.121 0 0 1.005-.316 3.3 1.209.96-.262 1.98-.392 3-.398 1.02.006 2.04.136 3 .398 2.28-1.525 3.285-1.209 3.285-1.209.645 1.624.24 2.823.12 3.121.765.825 1.23 1.877 1.23 3.164 0 4.53-2.805 5.527-5.475 5.817.42.354.81 1.077.81 2.182 0 1.578-.015 2.846-.015 3.229 0 .309.21.678.825.56 4.801-1.548 8.236-5.97 8.236-11.173 0-6.512-5.373-11.792-12-11.792z"></path></svg>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("components/icons/github.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$2]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_IconsTwitter = __nuxt_component_0;
  const _component_IconsFacebook = __nuxt_component_1;
  const _component_IconsGithub = __nuxt_component_2$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex justify-between m-6" }, _attrs))}><p class="text-xs font-semibold text-gray-600">Strapi Starter Nuxt.js E-commerce</p><div class="flex"><a href="https://twitter.com/strapijs" class="max-w-xs ml-4">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_IconsTwitter, null, null, _parent));
  _push(`</a><a href="https://facebook.com/strapijs" class="ml-3">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_IconsFacebook, null, null, _parent));
  _push(`</a><a href="https://github.com/strapi/strapi-starter-nuxt-e-commerce" class="ml-3">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_IconsGithub, null, null, _parent));
  _push(`</a></div></div>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Buttons = _sfc_main$9;
  const _component_Footer = __nuxt_component_2;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex justify-center bg-gray-200" }, _attrs))}><div class="max-w-screen-lg flex flex-col min-h-screen w-full">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Navbar, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_Buttons, null, null, _parent));
  ...
  _push(`</div><div hidden id="snipcart" data-api-key="ODhhNWUxOGEtNTk0OC00OTQwLWJkOWMtM2M1ZmNjODU1ZDJhNjM3MzMyNzM0NjM1OTMyNjcz"></div></div>`);
}
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
      if (__props.error) {
        _push(`<div>${serverRenderer.exports.ssrInterpolate(__props.error)}</div>`);
      } else {
        _push(`<div class="m-6 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-8"><!--[-->`);
        serverRenderer.exports.ssrRenderList(__props.products, (product) => {
          _push(`<div class="border rounded-lg bg-gray-100 hover:shadow-lg shadow-md">`);
          _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
            to: `/products/${product.slug}`
          }, {
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="rounded-t-lg bg-white pt-2 pb-2"${_scopeId}><img class="crop mx-auto"${serverRenderer.exports.ssrRenderAttr("src", `${vue_cjs_prod.unref(getMedia)(product.image.formats.thumbnail.url)}`)}${_scopeId}></div><div class="pl-4 pr-4 pb-4 pt-4 rounded-lg"${_scopeId}><h4 class="mt-1 font-semibold text-base leading-tight truncate text-gray-700"${_scopeId}>${serverRenderer.exports.ssrInterpolate(product.title)} sticker </h4><div class="mt-1 text-sm text-gray-700"${_scopeId}>${serverRenderer.exports.ssrInterpolate(product.description)}</div></div>`);
              } else {
                return [
                  vue_cjs_prod.createVNode("div", { class: "rounded-t-lg bg-white pt-2 pb-2" }, [
                    vue_cjs_prod.createVNode("img", {
                      class: "crop mx-auto",
                      src: `${vue_cjs_prod.unref(getMedia)(product.image.formats.thumbnail.url)}`
                    }, null, 8, ["src"])
                  ]),
                  vue_cjs_prod.createVNode("div", { class: "pl-4 pr-4 pb-4 pt-4 rounded-lg" }, [
                    vue_cjs_prod.createVNode("h4", { class: "mt-1 font-semibold text-base leading-tight truncate text-gray-700" }, vue_cjs_prod.toDisplayString(product.title) + " sticker ", 1),
                    vue_cjs_prod.createVNode("div", { class: "mt-1 text-sm text-gray-700" }, vue_cjs_prod.toDisplayString(product.description), 1)
                  ])
                ];
              }
            }),
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    const { data, error } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("categories", () => fetch(`${config.STORE_URL}/categories/${route.params.id}`).then((response) => response.json()))), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Products = _sfc_main$3;
      _push(serverRenderer.exports.ssrRenderComponent(_component_Products, vue_cjs_prod.mergeProps({
        products: vue_cjs_prod.unref(data).products,
        error: vue_cjs_prod.unref(error)
      }, _attrs), null, _parent));
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("pages/categories/[id].vue");
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const config = useRuntimeConfig();
    const { data, error } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useAsyncData("products", () => fetch(`${config.STORE_URL}/products`).then((response) => response.json()))), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Products = _sfc_main$3;
      _push(serverRenderer.exports.ssrRenderComponent(_component_Products, vue_cjs_prod.mergeProps({
        products: vue_cjs_prod.unref(data),
        error: vue_cjs_prod.unref(error),
        storeUrl: vue_cjs_prod.unref(config).STORE_URL
      }, _attrs), null, _parent));
    };
  }
};
...
const useProductById = async () => {
  const config = useRuntimeConfig();
  const route = vueRouter_cjs_prod.useRoute();
  const { data, error } = await useAsyncData("products_by_id", () => fetch(`${config.STORE_URL}/products/${route.params.id}`).then((response) => response.json()));
  const product = data;
  const customFields = vue_cjs_prod.computed(() => {
    return product.value["Custom_field"].map(({ title, required, options }) => ({
      name: title,
      required,
      options
    })).map((x, index2) => Object.entries(x).map(([key, value]) => ({
      [`data-item-custom${index2 + 1}-${key.toString().toLowerCase()}`]: value
    }))).reduce((acc, curr) => acc.concat(curr), []).reduce((acc, curr) => __spreadValues(__spreadValues({}, acc), curr));
  });
  return {
    product,
    error,
...
const _sfc_main = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const route = vueRouter_cjs_prod.useRoute();
    const { product, error, customFields } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useProductById()), __temp = await __temp, __restore(), __temp);
    const { getMedia } = useGetMedia();
    return (_ctx, _push, _parent, _attrs) => {
      if (vue_cjs_prod.unref(product)) {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div class="m-6 mt-56 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 mt-8"><div class="rounded-t-lg pt-2 pb-2"><img${serverRenderer.exports.ssrRenderAttr("src", `${vue_cjs_prod.unref(getMedia)(vue_cjs_prod.unref(product).image.formats.thumbnail.url)}`)} class="m-auto"></div><div class="w-full p-5 flex flex-col justify-between"><div><h4 class="mt-1 font-semibold text-lg leading-tight truncate text-gray-700">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(product).title)} - $${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(product).price)}</h4><div class="mt-1 text-gray-600">${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(product).description)}</div></div>`);
        if (vue_cjs_prod.unref(product).status === "published") {
          _push(`<button${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
            ...
            "data-item-id": vue_cjs_prod.unref(product).id,
            "data-item-price": vue_cjs_prod.unref(product).price,
            "data-item-url": `${vue_cjs_prod.unref(route).fullPath}`,
            "data-item-description": vue_cjs_prod.unref(product).description,
            "data-item-image": `${vue_cjs_prod.unref(getMedia)(vue_cjs_prod.unref(product).image.formats.thumbnail.url)}`,
            "data-item-name": vue_cjs_prod.unref(product).title
          }, vue_cjs_prod.unref(customFields)))}> Add to cart </button>`);
        } else {
          _push(`<div class="text-center mr-10 mb-1"><div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert"><span class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">Coming soon...</span><span class="font-semibold mr-2 text-left flex-auto">This article is not available yet.</span></div></div>`);
        }
        _push(`</div></div></div>`);
      } else {
        _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(error))}</div>`);
      }
    };
  }
};
